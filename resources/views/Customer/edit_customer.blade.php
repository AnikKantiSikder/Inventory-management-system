                            ...
                            <div class="col-md-8">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form role="form" action="{{ url('/update-customer/'.$allData->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="city" value="{{ $allData->city }}" >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="bank_branch" value="{{ $allData->bank_branch }}">
                                            </div>
